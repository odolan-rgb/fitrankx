    ...
    >
      ...
      >
        ...
        <View style={styles.toastText}>
          <Text style={styles.toastHeading}>🏅 Badge unlocked!</Text>
...
export default function TabsLayout() {
  ...
  // Show one badge at a time; the next one (if any) will show after dismiss
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      {currentBadge && (
        <BadgeToast badge={currentBadge} onDismiss={handleDismiss} />
      )}
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  toastText: { flex: 1 },
  toastHeading: { color: '#a855f7', fontSize: 11, fontWeight: '700', textTransform: 'uppercase', marginBottom: 2 },
